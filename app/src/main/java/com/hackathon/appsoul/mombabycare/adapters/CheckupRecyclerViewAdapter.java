...
import com.hackathon.appsoul.mombabycare.adapters.CheckupRecyclerViewAdapter.ViewHolder;
...
public class CheckupRecyclerViewAdapter extends RecyclerView.Adapter<ViewHolder> {

   private Context context;
   private ArrayList<CheckupModel> checkupModelArrayList;
   private int previousPosition = 0;
   
   public CheckupRecyclerViewAdapter(Context context, ArrayList<CheckupModel> checkupList) {
